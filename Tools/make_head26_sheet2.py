...
d.text((PAD, 72), u'★ 头簇（39 叶 + 鬃/须/角/颌）是刚性分支、从不被驱动 ⇒ 挂点被拧多少，头就歪多少（自检 0.0000° 证实）。',
       font=F_S, fill=(70, 70, 70))
d.text((PAD, 94), u'★ 三档全歪 ＝ 你说的问题；根源是拉直那一步把挂点转了 93.37°，而旧锁锁的正是拉直后的姿态。',
...
for r in range(4):
    ...
    for i, line in enumerate(sub):
        d.text((PAD + 12, y + 40 + i * 22), line, font=F_X, fill=(60, 110, 60) if r in (0, 3) else (100, 100, 100))
...
d.text((PAD + 240, y_wide - 28), u'基准档身体是 C 形弯的、其余三档是直的 —— 那是拉直的效果（预期）。',
